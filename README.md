# 🧑‍🎓 Sistem Absensi Mahasiswa (Web Based)

Proyek ini merupakan **aplikasi web absensi mahasiswa sederhana** yang dibangun menggunakan **HTML, CSS, dan JavaScript murni (native)** tanpa backend.  
